...
//     ? F extends ('' | false | [] | undefined | null | 0)
//       ? AnyOf<R>
...
//   ? false
//   : T extends [infer F, ...infer R] 
//     ? F extends ('' | false | [] | { [K: string]: never } | undefined | null | 0)
//       ? AnyOf<R>
//       : true
//     : never

type AnyOf<T extends any[]> = T[number] extends  ('' | false | [] | { [K: string]: never } | undefined | null | 0)
  ? false
  : true
