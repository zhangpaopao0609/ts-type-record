...
// type Triangular<N extends number, Next extends number[] = [], U extends number[] = []> =
//     Next['length'] extends N
//     ? [...U, ...NumberToArr<N>]['length']
//     : Triangular<N, [...Next, 0], [...U, ...Next]>

type Triangular<N extends number, P extends number[] = [], A extends number[] = []> =
    P['length'] extends N 
    ? A['length'] 
    : Triangular<N, [...P, 0], [...A, ...P, 0]>    
