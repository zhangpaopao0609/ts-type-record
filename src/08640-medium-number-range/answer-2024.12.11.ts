...
// type NumberRange<L extends number, H extends number, Start extends number[] = [], End extends number[] = [],  R extends number[] = []> =
// Start['length'] extends L
//   ? End['length'] extends H
//     ? [...R, H][number]
//     : NumberRange<L, H, Start,[...End, End['length']], [...R, End['length']]>
//   : NumberRange<L, H, [...Start, Start['length']], [...End, End['length']], []>
